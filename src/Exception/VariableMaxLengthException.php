 ...
 * @package Exception
 */
class VariableMaxLengthException extends VariableLengthException
{
    /**
     ...
     */
    public function __construct(string $variable, int $maxLen = null, $code = 0, Throwable $previous = null)
    {
        parent::__construct($variable, $maxLen, null, $code, $previous);
    }
}